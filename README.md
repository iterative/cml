...
| `skip_push`            | boolean | no       | false         | If `true` `dvc pull` and `git push` won't happen and tags will not be generated either. However the report will be generated in current commit.                                                                                         |
