...
const run = async (opts) => {
  ...
  console.log("Length of TEST_BBCLOUD_TOKEN: " + process.env.TEST_BBCLOUD_TOKEN.length)
  console.log("Length of TEST_GITHUB_TOKEN: " + process.env.TEST_GITHUB_TOKEN.length)
  console.log("Length of TEST_GITLAB_TOKEN: " + process.env.TEST_GITLAB_TOKEN.length)
